  ...
  for (const architecture of ['arm64', 'x86_64'] as const) {
    ...
    if (storeCatalog.response.ok) {
      ...
      assert.deepEqual(
        ...
        [
          [0, '10000000000000000000000000000001', '20000000000000000000000000000001', 10, 20],
          [1, '10000000000000000000000000000001', '20000000000000000000000000000002', 38, 40],
          [2, '10000000000000000000000000000002', '20000000000000000000000000000003', 4, 12],
        ],
      )
